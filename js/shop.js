        ...
        if (_shopView === 'tackle') {
            ...
            var sections = [
              ...
              { key:'Reels', label:'Reels', items:[
                  ...
                  {id:'big_pit_14k_reel', name:'Big Pit 14k Reel', cost:5500, icon:'🔄', image:'img/reels/reel4.png', category:'Reel', description:'14k high-speed retrieve for instant line pickup.', effects:{castRangeBonus:0.09, catchRateBonus:0.03, reputationBonus:1}, prerequisite:'big_pit_12k_reel', unlocks:[]}
              ]},
              ...
              { key:'Leads', label:'Leads', items:[
                  {id:'backlead_1oz', name:'1oz Backlead', cost:400, icon:'🪨', image:'img/tackle/1ozlead.png', category:'Leads', description:'Light backlead for slip presentations.', effects:{castRangeBonus:0.02}, prerequisite:null, unlocks:['inline_lead_2oz']},
                  {id:'inline_lead_2oz', name:'2oz Inline Lead', cost:500, icon:'🪨', image:'img/tackle/inlinelead.png', category:'Leads', description:'Classic inline lead for distance.', effects:{castRangeBonus:0.03, hookSetBonus:0.02}, prerequisite:'backlead_1oz', unlocks:['window_lead_2oz']},
                  {id:'window_lead_2oz', name:'2oz Window Lead', cost:650, icon:'🪨', image:'img/tackle/2ozlead.png', category:'Leads', description:'Window lead for hard lake beds.', effects:{hookSetBonus:0.03}, prerequisite:'inline_lead_2oz', unlocks:['method_lead_3oz']},
