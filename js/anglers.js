...
const Anglers = (function () {
    ...
    var TACKLE_CATALOG = [
        ...
        { id:'rod_custom_carp', name:'Custom Carp Rod', cost:4800, image:'img/rigs/rod112.png', category:'Rod', description:'Bespoke build tuned for specimen carp.', effects:{castRangeBonus:0.08, catchRateBonus:0.04, breakStrengthBonus:0.02}, prerequisite:'rod_13ft_carp', unlocks:[]},
        // Reels
